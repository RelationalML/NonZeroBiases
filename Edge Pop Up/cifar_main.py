...
def main():
    ...
    # if args.save_model:
    torch.save(model.state_dict(), "runs-cifar/ticket" + "_" + str(args.seed) + "_" + str(args.sparsity) + "_" + str(args.bias) + "_" + str(args.scaled) + ".pt")
    ...
    #write_result_to_csv(
        ...
        #init=args.initBias,
        #epochs=args.levels,
        #anneal_epochs=args.anneal
    #)

def write_result_to_csv(**kwargs):
    results = pathlib.Path("runs-cifar") / "results.csv"
